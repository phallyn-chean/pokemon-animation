...
class ItemSelector extends ItemStateSelector<ItemSelectorState> {
  ItemSelector(int index, Widget Function(Item, bool) builder)
      : super(
          selector: (state) => ItemSelectorState(state.items[index], state.selectedItemIndex == index),
...
class ItemSelectorState {
  ...
  @override
  bool operator ==(Object other) => other is ItemSelectorState && item == other.item && selected == other.selected;
}

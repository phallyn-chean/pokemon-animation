...
class ItemState {
  ...
  ItemState asLoading() {
    return copyWith(status: ItemStateStatus.loading);
  }
  ...
  ItemState asLoadFailure(Exception e) {
    return copyWith(status: ItemStateStatus.loadFailure, error: e);
  }
  ...
  ItemState asLoadMoreFailure(Exception e) {
    return copyWith(status: ItemStateStatus.loadMoreFailure, error: e);
  }
  ...
  ItemState copyWith({
    ...
    return ItemState._(
      ...
      selectedItemIndex: selectedPokemonIndex ?? selectedItemIndex,
      page: page ?? this.page,
